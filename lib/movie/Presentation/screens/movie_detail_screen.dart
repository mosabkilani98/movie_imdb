...
import 'package:movieproject/movie/Presentation/screens/dummy.dart';
...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (BuildContext context) => sl<MovieDetailBloc>()
        ..add(GetMovieDetailEvent(id))
        ..add(GetMovieRecomendationEvent(id)),
...
class MovieDetailContent extends StatelessWidget {
              ...
              background: FadeIn(
                ...
                child: ShaderMask(
                  ...
                  child: CachedNetworkImage(
                    ...
                    imageUrl: AppConsctance.imageUrl(state.movieDetail!.backdropPath),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8.0),
                    Text(
                      'Genres: ${_showGenres(state.movieDetail!.geners)}',
                      style: const TextStyle(
                        color: Colors.white70,
                        fontSize: 12.0,
                        fontWeight: FontWeight.w500,
  ...
  Widget _showRecommendations() {
    return BlocBuilder<MovieDetailBloc,MovieDetailState>(
      builder: (context, state) {return SliverGrid(
        delegate: SliverChildBuilderDelegate(
          (context, index) {
            final recommendation = state.recomendationDetail[index];
            return FadeInUp(
              from: 20,
              duration: const Duration(milliseconds: 500),
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: AppConsctance.imageUrl(recommendation.backdroppath!),
          ...
          childCount: state.recomendationDetail.length,
        ),
